...
new Vue({
    ...
    methods: {
        ...
        onAddClick: function () {
            ...
            request({ url: '/api/Login/checkMobileCode', method: 'post', data: { mobile: this.mobile, code: this.code } }).then(function (res) {
                if (res.code == 200) {
                    window.location.href = "./password3.html?mobile=".concat(_this.mobile, "&code=").concat(_this.code);
                }
                else {
                    layer.msg(res.msg);
                }
