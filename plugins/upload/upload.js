function DragImgUpload(id,iszt,options) {
    ...
    this.preview = iszt?$('<div id="preview"><img src="images/pub21.png" class="img-responsive"  style="width: 100%;height: auto;" alt="" title=""></div>'):$('<div id="preview"><img src="images/pub21.png" class="img-responsive"  style="width: 100%;height: auto;" alt="" title=""></div>');
